...
RUN_DIR="${ROOT_DIR}/runs/all_global_topk_oracle2x2_distributed_gpu012_$(date +%Y%m%d_%H%M%S)"
mkdir -p "${RUN_DIR}"
...
declare -a CONFIGS=(
  "eval_vggt_eth3d_query_topk_all_layers_r10.yaml"
  "eval_vggt_eth3d_oracle_2x2_all_layers.yaml"
)
